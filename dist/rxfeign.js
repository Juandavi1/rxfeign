...
function addInterceptors(...interceptor) {
    interceptor.forEach(i => exports.interceptors.unshift(new i()));
}
...
function request(method, urlToMatch = '', statusCodeOk) {
    return (target, propertyKey, descriptor) => {
        descriptor.value = (...arguments_) => {
            ...
            let config = Reflect.getMetadata(configMetadataKey, target, propertyKey) || {};
            ...
            if (typeof mainConfig === 'object') {
                ...
                config = mainConfig.config ? Object.assign({}, mainConfig.config, config) : config;
            }
            else
                mainUrl = mainConfig;
            ...
            return rxjs_1.from(axios_1.default.request(Object.assign({ method: request.method, data: request.body, headers: request.headers, url: request.url, responseType: "json" }, config)))
